...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $home_slider = Slider::all();
        $home_intro  = Introsection::all();
        $middle_page = MiddlePage::all();
        $platform_environment = PlatformEnvironment::all();
        $after_platform = AfterPlatformEnvironment::all();
        $start_steps = StartSteps::all();
        $user_opinions = UsersOpinions::all();
        $before_footer = BeforeFooter::all();
        $footer  = Footer::all();

        return view('frontend.index',compact('home_slider','home_intro','middle_page','platform_environment','after_platform','start_steps','user_opinions','before_footer','footer'));
    }
