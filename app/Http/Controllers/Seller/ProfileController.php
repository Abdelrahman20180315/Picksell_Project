...
class ProfileController extends Controller
{
    ...
    public function update(SellerProfileRequest $request , $id)
    {
        ...
        $user->trader_code = $request->trader_code;

        if( $user->current_password == $request->current_password && ($request->new_password != null) && ($request->new_password == $request->confirm_password)){
