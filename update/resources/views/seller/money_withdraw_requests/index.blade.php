                  ...
                  <tbody>
                      @foreach ($seller_withdraw_requests as $key => $seller_withdraw_request)
                          <tr>
                              ...
                              <td>{{ $seller_withdraw_request->payment_method}}</td>
                              <td>{{ $seller_withdraw_request->phone_number}}</td>
                              <td>
                    ...
                    <form class="" action="{{ route('seller.money_withdraw_request.store') }}" method="post">
                        ...
                        <div class="modal-body gry-bg px-3 pt-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <select name="payment_method" lang="en" class="form-control mb-3" required>
                                        <option value="vodafone cash">Vodafone Cash</option>
                                        <option value="etisalate cash">Etisalate Cash</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" lang="en" class="form-control mb-3" name="phone_number"  placeholder="{{ translate('Phone Number') }}" required>
                                </div>
                            </div>
