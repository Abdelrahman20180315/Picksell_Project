        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group row">
                    <label class="col-md-2 col-form-label" for="name">{{ translate('Your First Name') }}</label>
                    <div class="col-md-10">
                        <input type="text" name="name" value="{{ $user->name }}" id="name" class="form-control" placeholder="{{ translate('Your First Name') }}" required>
                        @error('name')
                ...
                <div class="form-group row">
                    <label class="col-md-2 col-form-label" for="last_name">{{ translate('Your Last Name') }}</label>
                    <div class="col-md-10">
                        <input type="text" name="last_name" value="{{ $user->last_name }}" id="last_name" class="form-control" placeholder="{{ translate('Your Last Name') }}" required>
                        @error('last_name')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    <label class="col-md-2 col-form-label" for="trader_code">{{ translate('Your Code') }}</label>
                    <div class="col-md-10">
                        <input type="text" name="trader_code" value="{{ $user->trader_code }}" id="trader_code" class="form-control" readonly placeholder="{{ translate('Your Code') }}" required>
                        @error('trader_code')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    <label class="col-md-2 col-form-label" for="current_password">{{ translate('Your Current Password') }}</label>
                    <div class="col-md-10">
                        <input type="password" name="current_password" id="current_password" class="form-control" placeholder="{{ translate('Current Password') }}">
