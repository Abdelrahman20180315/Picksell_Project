            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a class="aiz-side-nav-link" href="{{url('admin/showhomeslider')}}">
                                    <span class="aiz-side-nav-text">{{translate('Show Home Slider')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a class="aiz-side-nav-link" href="{{url('admin/addhomeslider')}}">
                                    <span class="aiz-side-nav-text">{{translate('Add Home Slider')}}</span>
                                </a>
                            </li>
                            
                            <li class="aiz-side-nav-item">
                                <a href="{{url('admin/showhomeintrosection')}}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Show Intro Section') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{url('admin/addhomeintrosection')}}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Add home Intro Section')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{url('admin/showhomemiddlepage')}}" class="aiz-side-nav-link {{ areActiveRoutes(['products.admin', 'products.create', 'products.admin.edit']) }}" >
                                    <span class="aiz-side-nav-text">{{ translate('Show Home Middle Page') }}</span>
                                </a>
                            </li>

                            <li class="aiz-side-nav-item">
                                <a href="{{url('admin/addhomemiddlepage')}}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Add Home Middle Page')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{url('admin/showhomeplatformenvironment')}}" class="aiz-side-nav-link {{ areActiveRoutes(['products.admin', 'products.create', 'products.admin.edit']) }}" >
                                    <span class="aiz-side-nav-text">{{ translate('show Home Platform Environment') }}</span>
                                </a>
                            </li>

                            <li class="aiz-side-nav-item">
                                <a href="{{url('admin/addhomeplatformenvironment')}}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Add home Platform Environment')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{url('admin/showafterhomeenvironment')}}" class="aiz-side-nav-link {{ areActiveRoutes(['products.admin', 'products.create', 'products.admin.edit']) }}" >
                                    <span class="aiz-side-nav-text">{{ translate('Show After Home Environment') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{url('admin/addafterhomeenvironment')}}" class="aiz-side-nav-link {{ areActiveRoutes(['products.admin', 'products.create', 'products.admin.edit']) }}" >
                                    <span class="aiz-side-nav-text">{{ translate('Add After Home Environment') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{url('admin/showhomestartsteps')}}" class="aiz-side-nav-link {{ areActiveRoutes(['products.admin', 'products.create', 'products.admin.edit']) }}" >
                                    <span class="aiz-side-nav-text">{{ translate('Show Home Start Steps') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{url('admin/addhomestartsteps')}}" class="aiz-side-nav-link {{ areActiveRoutes(['products.admin', 'products.create', 'products.admin.edit']) }}" >
                                    <span class="aiz-side-nav-text">{{ translate('Add Home Start Steps') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{url('admin/showhomeuseropinions')}}" class="aiz-side-nav-link {{ areActiveRoutes(['products.admin', 'products.create', 'products.admin.edit']) }}" >
                                    <span class="aiz-side-nav-text">{{ translate('Show Home User Opinions') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{url('admin/addhomeuseropinions')}}" class="aiz-side-nav-link {{ areActiveRoutes(['products.admin', 'products.create', 'products.admin.edit']) }}" >
                                    <span class="aiz-side-nav-text">{{ translate('Add Home User Opinions') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{url('admin/showhomebeforefooter')}}" class="aiz-side-nav-link {{ areActiveRoutes(['products.admin', 'products.create', 'products.admin.edit']) }}" >
                                    <span class="aiz-side-nav-text">{{ translate('Show Home Before Footer') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{url('admin/addhomebeforefooter')}}" class="aiz-side-nav-link {{ areActiveRoutes(['products.admin', 'products.create', 'products.admin.edit']) }}" >
                                    <span class="aiz-side-nav-text">{{ translate('Add Home Before Footer') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{url('admin/showhomefooter')}}" class="aiz-side-nav-link {{ areActiveRoutes(['products.admin', 'products.create', 'products.admin.edit']) }}" >
                                    <span class="aiz-side-nav-text">{{ translate('Show Home Footer') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{url('admin/addhomefooter')}}" class="aiz-side-nav-link {{ areActiveRoutes(['products.admin', 'products.create', 'products.admin.edit']) }}" >
                                    <span class="aiz-side-nav-text">{{ translate('Add Home Footer') }}</span>
                                </a>
                            </li>
                    ...
                    @if(Auth::user()->user_type == 'admin' || in_array('7', json_decode(Auth::user()->staff->role->permissions)))
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{url('admin/product_replacement')}}" class="aiz-side-nav-link {{ areActiveRoutes(['admin/product_replacement'])}}">
                                        <span class="aiz-side-nav-text">{{translate('Product Replacement Requests')}}</span>
                                    </a>
                                </li>
                                {{-- <li class="aiz-side-nav-item">
                                    <a href="{{url('admin/product_recovery')}}" class="aiz-side-nav-link {{ areActiveRoutes(['admin/product_recovery'])}}">
                                        <span class="aiz-side-nav-text">{{translate('Product Replacement Requests')}}</span>
                                    </a>
                                </li> --}}
