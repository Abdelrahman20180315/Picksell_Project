                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" lang="en" min="0" value="0" step="0.01" id="unitprice" placeholder="{{ translate('Unit price') }}" name="unit_price" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" lang="en" min="0" value="0" step="0.01" id="earn"  placeholder="{{ translate('Earn') }}" onkeyup="calculate()"   name="earn" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('total Price')}} <span class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input type="text" lang="en" min="0" value="0" step="0.01"  id="totalprice" placeholder="{{ translate('total Price') }}" name="total"  readonly  class="form-control" required>
                            </div>
                        </div>
