                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" id="unitprice" placeholder="{{translate('Unit price')}}" name="unit_price" class="form-control" value="{{$product->unit_price}}" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Earn')}} <span class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input type="text" lang="en" min="0"  step="0.01" id="earn"  placeholder="{{ translate('Earn') }}" onkeyup="calculate()"   name="earn"   class="form-control" value="{{$product->earn}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('total Price')}} <span class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input type="text" lang="en" min="0"  step="0.01"  id="totalprice" placeholder="{{ translate('total Price') }}" name="total"   readonly  class="form-control" value="{{$product->total}}" required>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function calculate()
    {
      var x = parseInt(document.getElementById('unitprice').value);
      var y = parseInt(document.getElementById('earn').value); 
