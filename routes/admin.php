...
//Home Content
//Slider
Route::get('/showhomeslider',[HomeContentController::class,'showhomeslider']);
Route::get('/addhomeslider',[HomeContentController::class,'addhomeslider']);
Route::post('/addhomesliderdata',[HomeContentController::class,'addhomesliderdata']);
Route::get('/edithomeslider/{id}',[HomeContentController::class,'edithomeslider']);
Route::post('/addedithomesliderdata/{id}',[HomeContentController::class,'addedithomesliderdata']);
Route::get('/deletehomeslider/{id}',[HomeContentController::class,'deletehomeslider']);


//Intro Section
Route::get('/showhomeintrosection',[HomeContentController::class,'showhomeintrosection']);
Route::get('/addhomeintrosection',[HomeContentController::class,'addhomeintrosection']);
Route::post('/addhomeintrosectiondata',[HomeContentController::class,'addhomeintrosectiondata']);
Route::get('/edithomeintrosection/{id}',[HomeContentController::class,'edithomeintrosection']);
Route::post('/addedithomeintrosectiondata/{id}',[HomeContentController::class,'addedithomeintrosectiondata']);
Route::get('/deletehomeintrosection/{id}',[HomeContentController::class,'deletehomeintrosection']);

//Middle Page
Route::get('/showhomemiddlepage',[HomeContentController::class,'showhomemiddlepage']);
Route::get('/addhomemiddlepage',[HomeContentController::class,'addhomemiddlepage']);
Route::post('/addhomemiddlepagedata',[HomeContentController::class,'addhomemiddlepagedata']);
Route::get('/edithomemiddlepage/{id}',[HomeContentController::class,'edithomemiddlepage']);
Route::post('/addedithomemiddlepagedata/{id}',[HomeContentController::class,'addedithomemiddlepagedata']);
Route::get('/deletehomemiddlepage/{id}',[HomeContentController::class,'deletehomemiddlepage']);

//Platform Environment
Route::get('/showhomeplatformenvironment',[HomeContentController::class,'showhomeplatformenvironment']);
Route::get('/addhomeplatformenvironment',[HomeContentController::class,'addhomeplatformenvironment']);
Route::post('/addhomeplatformenvironmentdata',[HomeContentController::class,'addhomeplatformenvironmentdata']);
Route::get('/edithomeplatformenvironment/{id}',[HomeContentController::class,'edithomeplatformenvironment']);
Route::post('/addedithomeplatformenvironmentdata/{id}',[HomeContentController::class,'addedithomeplatformenvironmentdata']);
Route::get('/deletehomeplatformenvironment/{id}',[HomeContentController::class,'deletehomeplatformenvironment']);

//After Platform Environment
Route::get('/showafterhomeenvironment',[HomeContentController::class,'showafterhomeenvironment']);
Route::get('/addafterhomeenvironment',[HomeContentController::class,'addafterhomeenvironment']);
Route::post('/addafterhomeenvironmentdata',[HomeContentController::class,'addafterhomeenvironmentdata']);
Route::get('/editafterhomeenvironment/{id}',[HomeContentController::class,'editafterhomeenvironment']);
Route::post('/addeditafterhomeenvironmentdata/{id}',[HomeContentController::class,'addeditafterhomeenvironmentdata']);
Route::get('/deleteafterhomeenvironment/{id}',[HomeContentController::class,'deleteafterhomeenvironment']);

//Start Steps
Route::get('/showhomestartsteps',[HomeContentController::class,'showhomestartsteps']);
Route::get('/addhomestartsteps',[HomeContentController::class,'addhomestartsteps']);
Route::post('/addhomestartstepsdata',[HomeContentController::class,'addhomestartstepsdata']);
Route::get('/edithomestartsteps/{id}',[HomeContentController::class,'edithomestartsteps']);
Route::post('/addedithomestartstepsdata/{id}',[HomeContentController::class,'addedithomestartstepsdata']);
Route::get('/deletehomestartsteps/{id}',[HomeContentController::class,'deletehomestartsteps']);

//User Opinions
Route::get('/showhomeuseropinions',[HomeContentController::class,'showhomeuseropinions']);
Route::get('/addhomeuseropinions',[HomeContentController::class,'addhomeuseropinions']);
Route::post('/addhomeuseropinionsdata',[HomeContentController::class,'addhomeuseropinionsdata']);
Route::get('/edithomeuseropinions/{id}',[HomeContentController::class,'edithomeuseropinions']);
Route::post('/addedithomeuseropinionsdata/{id}',[HomeContentController::class,'addedithomeuseropinionsdata']);
Route::get('/deletehomeuseropinions/{id}',[HomeContentController::class,'deletehomeuseropinions']);

//Before Footer
Route::get('/showhomebeforefooter',[HomeContentController::class,'showhomebeforefooter']);
Route::get('/addhomebeforefooter',[HomeContentController::class,'addhomebeforefooter']);
Route::post('/addhomebeforefooterdata',[HomeContentController::class,'addhomebeforefooterdata']);
Route::get('/edithomebeforefooter/{id}',[HomeContentController::class,'edithomebeforefooter']);
Route::post('/addedithomebeforefooterdata/{id}',[HomeContentController::class,'addedithomebeforefooterdata']);
Route::get('/deletehomebeforefooter/{id}',[HomeContentController::class,'deletehomebeforefooter']);

//Footer
Route::get('/showhomefooter',[HomeContentController::class,'showhomefooter']);
Route::get('/addhomefooter',[HomeContentController::class,'addhomefooter']);
Route::post('/addhomefooterdata',[HomeContentController::class,'addhomefooterdata']);
Route::get('/edithomefooter/{id}',[HomeContentController::class,'edithomefooter']);
Route::post('/addedithomefooterdata/{id}',[HomeContentController::class,'addedithomefooterdata']);
Route::get('/deletehomefooter/{id}',[HomeContentController::class,'deletehomefooter']);


//Product Replacement

Route::post('/add_product_replacement',[ProductController::class,'add_product_replacement']);

Route::get('/product_replacement',[ProductController::class,'product_replacement_requests']);
